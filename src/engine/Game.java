...
public class Game {
	...
	public static void loadHeroes(String filePath) throws IOException {
		...
		BufferedReader br = new BufferedReader(new FileReader("Heroes.csv"));
	...
	public static void move(Hero selectedHero, Direction direction) throws MovementException, NotEnoughActionsException {
		
		selectedHero.move(direction);
	}

	public void attack(Hero selectedHero, Hero target) {
		// TODO Auto-generated method stub
		
	}

	public void useSpecial(Hero selectedHero) {
		// TODO Auto-generated method stub
